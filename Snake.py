...
"""FR : PROJET CODÉ PAR ANTHONY VAUCHEL
    ...
    Le but de ce projet était de recréer le célèbre jeu Snake dans le but d'apprendre Pygame
    
    EN: PROJECT CODED BY ANTHONY VAUCHEL
    
    PERSONAL PROJECT
    
    The aim of this project was to recreate the famous Snake game with the goal of learning Pygame."""
